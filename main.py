...
# ttk.Button(application, text="Choose Color", command=Choose_color).grid(column=0, row=0)#added button to use function 'Choose_color', for more reference check function description
...
canvas = Canvas(root, cursor="circle", width=100, height=100, bg="#ffffff")#creating canva to draw on, setting circle cursor to make drawing experience better
